...
<head>
  <title>Laporan Belum Bayar Retribusi</title>
...
<body>
  ...
  <div style="text-align: center; font-size:20pt">
    <strong>(REKAP DATA BELUM BAYAR RETRIBUSI)</strong>
  </div>

  <p>
  <div class="row" style="font-size: 14pt">
    <div class="col-sm-3">SKPD</div>
    <div class="col-sm-9">: <b>Dinas Lingkungan Hidup Kota Bandar Lampung</b>
    </div>
  </div>
  <div class="row" style="font-size: 14pt">
    <div class="col-sm-3">Pimpinan</div>
    <div class="col-sm-9">: <b>Drs. A. BUDIMAN PM.,MM.</b>
    </div>
  </div>
  <div class="row" style="font-size: 14pt">
    <div class="col-sm-3">Periode</div>
    <div class="col-sm-9">: <b><?php echo date('d F Y', strtotime($awalTgl)); ?></b> s/d
      <b><?php echo date('d F Y', strtotime($akhirTgl)); ?></b>
    </div>
  </div>
  </p>
