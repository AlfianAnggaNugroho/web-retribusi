...
<div class="card">
  <div style="background: linear-gradient(20deg, #000066 0%, #642EFE 70%, red 100%); color: white;"
    class="card-header text-white">
    <div style="display: flex; justify-content: space-between; align-items: center;">
      <div style="display: flex; align-items: center;">
        <i class="fas fa-print" style="margin-right: 10px;"></i>
        <h6 style="margin: 0;"><b>LAPORAN BELUM BAYAR RETRIBUSI</b></h6>
      </div>
      ...
      <div class="row mb-3">
        <div class="col-lg-3" style="max-height: 150px; overflow-y: auto;">
          ...
          <select name="cmbPetugas" class="form-control">
            ...
            <?php
        $sqlPetugas = "SELECT DISTINCT nama_petugas FROM tb_retribusi_b_byr";
        ...
        <div class="col-lg-3" style="max-height: 150px; overflow-y: auto;">
          ...
          <select name="cmbNamaObjek" class="form-control">
            ...
            <?php
        $sqlNamaObjek = "SELECT DISTINCT nama_objek FROM tb_retribusi_b_byr";
        ...
        <?php if (!$isAdmin) { ?>
        <div class="col-lg-2 ml-auto">
          <a href="cetak_b_bayar?awal=<?php echo $tglAwal; ?>&akhir=<?php echo $tglAkhir; ?>&petugas=<?php echo $petugas; ?>&objek=<?php echo $namaobjek; ?>"
    ...
    <div class="table-responsive">
      <table id="example1" class="table table-bordered table-hover">
        ...
        <tbody>
          ...
          <?php                                
                                $sql = "SELECT A.* FROM tb_retribusi_b_byr A $sqlPeriode ORDER BY A.tanggal ASC";
