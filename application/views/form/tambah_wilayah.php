...
<div class="card-container">
  <div class="card custom-card"
    ...
    <div class="card-body">
      <form action="<?= base_url('wilayah/tambah_aksi') ?>" method="POST">
        <div class="form-group">
          <label for="nama_wilayah">Nama Wilayah</label>
          <input type="text" name="nama_wilayah" class="form-control" id="nama_wilayah" placeholder="Wilayah">
    ...
    <div class="card-footer">
      <div class="form-group text-center d-flex justify-content-between">
        ...
        <a type="button" class="btn btn-info col-md-4 mx-4" href="<?=base_url('wilayah')?>" name="btn_listsatuan">
          <i class="fa fa-table" aria-hidden="true"></i> Lihat Data Wilayah
        </a>
        <button
  ...
  <div class="card custom-card2">
    ...
    <div class="card-body">
      <p class="card-text">Tambahkan wilayah UPT menggunakan form yang sudah disediakan. Jika form sudah di isi
